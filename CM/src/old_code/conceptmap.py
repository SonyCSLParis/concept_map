# -----------------------------------------------------------
# python file to get concept maps
#
# (C)
# -----------------------------------------------------------
...
'''
Function to get the important concepts using the DBpedia spotlight web API
query = text
'''
...
def main(argv):
    ...
    try:
        ...
        print('minimal_examples.py -i <inputfile> -o <outputfile>')
        sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
            print('minimal_examples.py -i <inputfile> -o <outputfile>')
    ...
    print(word_list)
    print(sentences)
    word_file = open('../../Desktop/concept-map-ijcai/ConceptMapsSummaries/data/word_list.txt', 'w')
    for item in word_list:
        word_file.write("%s\n" % item)


if __name__ == "__main__":
    print("Usage:minimal_examples.py -i <inputfile> -o <outputfile>")
    main(sys.argv[1:])
