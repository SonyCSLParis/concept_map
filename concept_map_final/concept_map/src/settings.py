...
SUMMARIES = os.path.join(OUTPUT_DIR + '/summary-single-doc')
...
if not os.path.exists(OUTPUT_DIR_SINGLE_DOC_DISJOINT):
    os.makedirs(OUTPUT_DIR_SINGLE_DOC_DISJOINT)

if not os.path.exists(OUTPUT_DIR_GRAPH_SINGLE_DOC):
    os.makedirs(OUTPUT_DIR_GRAPH_SINGLE_DOC)

if not os.path.exists(OUTPUT_DIR_TRIPLETS_DISJOINT_TEST):
    os.makedirs(OUTPUT_DIR_TRIPLETS_DISJOINT_TEST)

if not os.path.exists(OUTPUT_DIR_EVALUATION_CSV):
    os.makedirs(OUTPUT_DIR_EVALUATION_CSV)

if not os.path.exists(OUTPUT_DIR_TRIPLETS_AGGREGATE_TEST):
    os.makedirs(OUTPUT_DIR_TRIPLETS_AGGREGATE_TEST)

if not os.path.exists(OUTPUT_DIR_GRAPH_TEST):
    os.makedirs(OUTPUT_DIR_GRAPH_TEST)
